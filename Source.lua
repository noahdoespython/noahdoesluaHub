...
local Utility = {}
local Objects = {}
function NoahdoesLua:DraggingEnabled(frame, parent)
...
local Name = "NoahdoesLuaConfig.JSON"
...
function NoahdoesLua.CreateLib(kavName, themeList)
    ...
    elseif themeList == "Dizcord" then
        themeList = themeStyles.Dizcord
    else
    ...
    table.insert(NoahdoesLua, kavName)
    ...
    NoahdoesLua:DraggingEnabled(MainHeader, Main)
    ...
    function NoahdoesLua:ChangeColor(prope,color)
